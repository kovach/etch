...
INSERT INTO NATION
SELECT N_NATIONKEY, N_NAME FROM t.NATION;

INSERT INTO PART
SELECT P_PARTKEY, P_NAME FROM t.PART;

INSERT INTO SUPPLIER
SELECT S_SUPPKEY, S_NATIONKEY FROM t.SUPPLIER;

INSERT INTO PARTSUPP
SELECT PS_PARTKEY, PS_SUPPKEY, PS_SUPPLYCOST FROM t.PARTSUPP;

INSERT INTO ORDERS
SELECT O_ORDERKEY, O_ORDERDATE FROM t.ORDERS;

INSERT INTO LINEITEM
SELECT L_ORDERKEY, L_PARTKEY, L_SUPPKEY, L_LINENUMBER, L_QUANTITY, L_EXTENDEDPRICE, L_DISCOUNT FROM t.LINEITEM;
